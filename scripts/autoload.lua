...
-- Rescan the folder of the playing file, optionally switching directory_mode
-- first. sort-playlist.lua sends this after clearing the playlist when the
-- "include subfolders" toggle changes.
mp.register_script_message("rescan", function(mode)
    if mode then
        o.directory_mode = mode
        validate_directory_mode()
    end
